...
public class GnomenWald {
	...
	public final static GnomenWald Gnomenwald = new GnomenWald();
	...
	// Constructor
	public GnomenWald(LinkedList<Village> villages) {
	...
	public Road createRoad(Village from, Village to) {
	...
	public void clearAll() {
		...
		this.roads.clear();
		this.villages.clear();
		Census.instance.population.clear();
	}
